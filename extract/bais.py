...
def download_tiktok_video(video_url: str, output_dir: str = None) -> str:
    ...
    if existing_video:
        print(f"[skip] Video already downloaded: {existing_video}")
...
def extract_audio(video_path: str, output_path: str = None) -> str:
    ...
    if os.path.exists(output_path):
        print(f"[skip] Audio already extracted: {output_path}")
        return output_path
...
def extract_frame(video_path: str, output_path: str = None, timestamp: str = "00:00:01") -> str:
    ...
    if os.path.exists(output_path):
        print(f"[skip] Frame already extracted: {output_path}")
        return output_path
    ...
    try:
        ...
        print("FFmpeg Error (frame extraction):")
        print(e.stderr)
        raise
